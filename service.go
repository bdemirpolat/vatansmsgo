...
func (data Report) GetReport() ([]ReportDetailResult, error) {
	...
	soap, err := gosoap.SoapClient(WebServiceUrl)
	if err != nil {
	...
	err = soap.Call("ikitariharasisorgulaXMLverID", params)
	if err != nil {
	...
	err = xml.Unmarshal(soap.Body, &reportDetailReturn)
	if err != nil {
...
func (data UserInfo) GetUser() (UserInfoResult, error) {
	...
	err = soap.Call("UyeBilgisiSorgula", params)
	if err != nil {
	...
	err = xml.Unmarshal(soap.Body, &userInfo)
	if err != nil {
